...
void AMultiplayertestCharacter::CreateGameSession()
{
...
void AMultiplayertestCharacter::OnCreateSessionComplete(FName SessionName, bool bWasSuccessful)
{
	if (bWasSuccessful)
	{
		...
		if (World)
		{
			World->ServerTravel(FString("/GameThirdPerson/Maps/LobbyLevel?listen"));
...
void AMultiplayertestCharacter::OpenLobby()
{
	UWorld* world=GetWorld();
	if (world) {
...
void AMultiplayertestCharacter::CallOpenLevel(const FString& Address)
{
	UGameplayStatics::OpenLevel(this, *Address);
}

void AMultiplayertestCharacter::CallClientTravel(const FString& Address)
{
	APlayerController* PlayerController = GetGameInstance()->GetFirstLocalPlayerController();
	if (PlayerController) {
		PlayerController->ClientTravel(Address, ETravelType::TRAVEL_Absolute);
